...
class RscStructuredTextTGVMenus
{
	moving = true;
    deletable = 0;
	fade = 0;
...
class RscShortcutButtonTGVMenus
{
    moving = true;
	deletable = 0;
	fade = 0;
...
class RscShortcutButtonMainTGVMenus
{
    moving = true;
	idc = -1;
	style = 0;
...
class RscButtonMenuCancelTGVMenus
{
    moving = true;
	idc = 2;
	shortcuts[] = 
...
class RscControlsGroupTGVMenus
{
    moving = true;
	deletable = 0;
	fade = 0;
